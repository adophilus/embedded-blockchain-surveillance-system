...
interface ISurveillanceSession {
    ...
    function listEvents() external returns (string[] memory ids, string[][] memory criminal_profile_ids, string[] memory cids, string[] memory device_codes, uint[] created_ats);
