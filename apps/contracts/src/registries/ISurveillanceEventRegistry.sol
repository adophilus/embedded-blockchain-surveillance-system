...
interface ISurveillanceEventRegistry {
    ...
    function recordEvent(string memory _id, string memory _sessionId, string[] memory _criminal_profile_ids, string memory _cid, string memory _device_code) external returns (string memory id);
